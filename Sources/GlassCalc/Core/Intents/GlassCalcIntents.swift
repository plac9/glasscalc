...
struct OpenCalculatorIntent: AppIntent {
    static let title: LocalizedStringResource = "Open GlassCalc"
    static let description = IntentDescription("Open the GlassCalc calculator app")
...
struct GlassCalcShortcuts: AppShortcutsProvider {
